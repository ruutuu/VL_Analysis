...
#D4: DATA ON RELAPSES AT DIFF TIMEPOINTS: VL_6MONTHPLUS_RELAPSE
#Variables for relapses at 6l, 6, 6p (Extracted manually by RC, PD)
setwd("C:/Users/Rutuja Chhajed/OneDrive - Nexus365/IDDO/Data")
...
#2) Subsetting studies with NA values
...
table(df_main$n_relapse)

df_all<-subset(df_main,!df_main$n_relapse<0) #No -ve values, but removing NAs as well!
