...
vl_main <-read_csv("VL_cleandata_0201.csv")
...
Creating new variables to mark that. Using our excel (vl_6 monthplus where we manually filled relapses at 6l, 6 and 6p)
```{r}
...
df_final<-subset(df_main,!df_main$n_relapse<0)
