...
op<-as.data.frame(t(as.data.frame(c(est0, lb0, ub0, est, lb, ub, i2, i2lb, i2ub, n, tot, tot_cured, tot_rel))))
colnames(op)<-c("est0","lb0","ub0","est","lb","ub","i2","i2lb","i2ub","n","tot", "cured","relapse")
rownames(op)<-NULL
...
m_table<-rbind(m_table, od1, od2, od3, od4, od5, od6, od7, od8, od9, od10, od11, od12, od13, od14, od15)
rm(m_drug1, m_drug2, m_drug3, m_drug4, m_drug5, m_drug6, m_drug7, m_drug8, m_drug9, m_drug10, m_drug11, m_drug12, m_drug13, m_drug14, m_drug16,m_drug17, m_drug15)

rm(od1, od2, od3, od4, od5, od6, od7, od8, od9, od10, od11, od12, od13, od14, od15)
...
write.csv(final,"MA_drugcat_region_6m_0215.csv")#Change date and name
...
```{r}
library(readxl)
res_6m <- read_excel("MA_drugcat_region_6m_0215.xlsx", 
...
```{r}
df_13<-subset(df_all,df_all$rmt360==1)
